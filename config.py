...
# check if common config files are present
...
# This method adds the project parents directory to the system path and may be essential when importing from app.server
def add_parent_directory_to_system_path():
